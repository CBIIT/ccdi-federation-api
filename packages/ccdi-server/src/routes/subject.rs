        ...
        (
            ...
            headers(
                (
                    ...
                    - The `prev` and `next` and next header must exist only \
                    (a) when there are multiple pages in the result page set \
                    and (b) when the current page is not the first and last \
                    page respectively.\n\
